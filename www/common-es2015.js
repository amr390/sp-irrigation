...
/***/ "./src/app/models/plot.ts":
/*!********************************!*\
  !*** ./src/app/models/plot.ts ***!
  \********************************/
/*! exports provided: Plot, Channel */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
class Plot {
    constructor(id, host, port, channels) {
        this.id = id;
        this.host = host;
        this.port = port || 80;
...
/* harmony import */ var _models_plot__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../models/plot */ "./src/app/models/plot.ts");
...
let ConnectionService = class ConnectionService {
    constructor(http) {
        this.http = http;
        this.plot = new _models_plot__WEBPACK_IMPORTED_MODULE_3__["Plot"](1, '192.168.18.122', 80);
        this.plot.channels = [
            new _models_plot__WEBPACK_IMPORTED_MODULE_3__["Channel"](1, 'Parcela Norte (P1)'),
            new _models_plot__WEBPACK_IMPORTED_MODULE_3__["Channel"](2, 'Parcela Este (P2)'),
            new _models_plot__WEBPACK_IMPORTED_MODULE_3__["Channel"](3, 'Parcela Sur (P3)')
        ];
    }
    checkStatus(plot) {
        return this.http.head(`http://${plot.host}:${plot.port}/healthCheck`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(() => true), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(err => Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["of"])(false)));
    }
    getPlot() {
        return this.plot;
    }
    toggleIrrigation(plot, channel) {
        return this.http.get(`http://${plot.host}:${plot.port}/irrigation/${channel.id}`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(() => true), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(err => Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["of"])(false)));
    }
    toggleFertilizer(plot, channel) {
        return this.http.get(`http://${plot.host}:${plot.port}/fertilizer/${channel.id}`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(() => true), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(err => Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["of"])(false)));
    }
};
