(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
    ...
    /***/
    function srcAppModelsPlotTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var Plot = function Plot(id, host, port, channels) {
    ...
    function srcAppServicesConnectionServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _models_plot__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ../models/plot */
      "./src/app/models/plot.ts");
      /* harmony import */
      ...
      var ConnectionService = /*#__PURE__*/function () {
        function ConnectionService(http) {
          ...
          this.plot.channels = [new _models_plot__WEBPACK_IMPORTED_MODULE_3__["Channel"](1, 'Parcela Norte (P1)'), new _models_plot__WEBPACK_IMPORTED_MODULE_3__["Channel"](2, 'Parcela Este (P2)'), new _models_plot__WEBPACK_IMPORTED_MODULE_3__["Channel"](3, 'Parcela Sur (P3)')];
        }

        _createClass(ConnectionService, [{
          key: "checkStatus",
          value: function checkStatus(plot) {
            return this.http.head("http://".concat(plot.host, ":").concat(plot.port, "/healthCheck")).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function () {
              return true;
          ...
          value: function toggleIrrigation(plot, channel) {
            return this.http.get("http://".concat(plot.host, ":").concat(plot.port, "/irrigation/").concat(channel.id)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function () {
              return true;
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (err) {
              return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["of"])(false);
            }));
          ...
          value: function toggleFertilizer(plot, channel) {
            return this.http.get("http://".concat(plot.host, ":").concat(plot.port, "/fertilizer/").concat(channel.id)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function () {
              return true;
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (err) {
              return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["of"])(false);
            }));
      ...
      ConnectionService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], ConnectionService);
      /***/
    }
